...
def myfunction (b_one, b_two, b_three):
    ...
    furniture_co.addConstr (5*x+2*y<=150, name = "constraint_1")
    furniture_co.addConstr (2*x+3*y<=100, name = "constraint_2")
    furniture_co.addConstr (4*x+2*y<=80, name = "constraint_3")
